...
def preparing_data_for_transfer(train,testset_0_1,test_label_0_1,svm3_pred):
    ...
    return transfer_test_set,transfer_test_set2,t_atomic_pca0_positive_mean,t_atomic_pca0_neg_mean,t_atomic_pca1_positive_mean,t_atomic_pca1_neg_mean
