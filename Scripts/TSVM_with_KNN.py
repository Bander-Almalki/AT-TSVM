...
class TransductiveSVM(svm.SVC):
    ...
    def fit(self, X1, Y1,Y_True,partial_labels10,partial_labels20,partial_labels30,partial_labels40,partial_labels50,partial_labels75,partial_index10,partial_index20,partial_index30,partial_index40,partial_index50,partial_index75,positive_mean_at0,neg_mean_at0,positive_mean_at1,neg_mean_at1):
        '''
        ...
        while (C_minus<self.Cu or C_plus<self.Cu): #LOOP 1
            ...
            f1_val_outer_10=f1_score(y_true=partial_labels10,y_pred= pred_outer[partial_index10])
            f1_val_outer_20=f1_score(y_true=partial_labels20,y_pred= pred_outer[partial_index20])
            f1_val_outer_30=f1_score(y_true=partial_labels30,y_pred= pred_outer[partial_index30])
            f1_val_outer_40=f1_score(y_true=partial_labels40,y_pred= pred_outer[partial_index40])
            f1_val_outer_50=f1_score(y_true=partial_labels50,y_pred= pred_outer[partial_index50])
            f1_val_outer_75=f1_score(y_true=partial_labels75,y_pred= pred_outer[partial_index75])

            print(f1_val_outer_10)
            validaation_f1_10.append(f1_val_outer_10)
            validaation_f1_20.append(f1_val_outer_20)
            validaation_f1_30.append(f1_val_outer_30)
            validaation_f1_40.append(f1_val_outer_40)
            validaation_f1_50.append(f1_val_outer_50)
            validaation_f1_75.append(f1_val_outer_75)
            ...
            while(condition): #LOOP 2
                ...
                KNN_prediction_scores[counter]=pred_inner
                ...
                f1_val_inner10=f1_score(y_true=partial_labels10,y_pred= pred_inner[partial_index10])
                f1_val_inner20=f1_score(y_true=partial_labels20,y_pred= pred_inner[partial_index20])
                f1_val_inner30=f1_score(y_true=partial_labels30,y_pred= pred_inner[partial_index30])
                f1_val_inner40=f1_score(y_true=partial_labels40,y_pred= pred_inner[partial_index40])
                f1_val_inner50=f1_score(y_true=partial_labels50,y_pred= pred_inner[partial_index50])
                f1_val_inner75=f1_score(y_true=partial_labels75,y_pred= pred_inner[partial_index75])

                validaation_f1_10.append(f1_val_inner10)
                validaation_f1_20.append(f1_val_inner20)
                validaation_f1_30.append(f1_val_inner30)
                validaation_f1_40.append(f1_val_inner40)
                validaation_f1_50.append(f1_val_inner50)
                validaation_f1_75.append(f1_val_inner75)

                print(f1_val_inner10)
                print("inner iter(",l,') precision:',precision_inner)
                print("inner iter(",l,') recall:',recall_inner)
                print("inner iter(",l,') ROC:',roc_inner)
                print("inner iter(",l,') F1:',f1_inner)

                pred_iter.append(precision_inner)
                f1_iter.append(f1_inner)
                KNN_f1_iter_scores[counter]=f1_inner
