...
def validation(transfer_test_set,test_label,test_label_0_1):
    ...
    return random_rows10,random_rows20,random_rows30,random_rows40,random_rows50,random_rows75,sample10,sample20,sample30,sample40,sample50,sample75,partial_labels10,partial_labels20,partial_labels30,partial_labels40,partial_labels50,partial_labels75
